        ...
        <div class="max-w-md mx-auto">
            ...
            <form method="POST" action="{{ route('resident.profile.change_password') }}">
                ...
                <div class="mb-4 form-input-group">
                    <input id="oldpassword" type="password" name="oldpassword" placeholder="Enter Current Password">
                </div>
                ...
                <div class="mb-3 form-input-group">
                    <input id="new_password_confirmation" type="password" name="new_password_confirmation" placeholder="Re-Enter New Password">
                </div>
