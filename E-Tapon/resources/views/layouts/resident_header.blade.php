...
<nav class="navbar navbar-expand-lg justify-content-center mt-0">
  <ul class="nav">
    <li class="nav-item">
      <a class="nav-link {{ request()->routeIs('resident.dashboard') ? 'active' : '' }}"
        href="{{ route('resident.dashboard') }}">
        Overview
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link {{ request()->routeIs('resident.schedule') ? 'active' : '' }}"
        href="{{ route('resident.schedule') }}">
        Schedule
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link {{ request()->routeIs('resident.request') ? 'active' : '' }}"
        href="{{ route('resident.request') }}">
        Request
      </a>
    </li>
  </ul>
